package edu.trinity.cpsc215f23.map;
...
public interface Map<K, V> {
     ...
     * was already in the map, this replaced the previous value with the new
     * one and returns the old value. Otherwise, a new entry is added and null
     * is returned.
     *
